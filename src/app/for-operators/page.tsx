...
const FAQS = [
  ...
  {
    q: "Is the platform live now?",
    a: "The tourism marketplace launches Q3 2026. We are currently admitting a curated early-access cohort of hosts and operators who will define what corridor tourism looks like at launch. Applying now secures your place in that cohort, with priority placement, reduced commission rates, and a dedicated onboarding call before launch.",
  },
  {
    q: "What does verification involve?",
    a: "For hosts: CAC registration (or individual ID for private properties), proof of ownership or management rights, property inspection, photography. For operators: CAC registration, relevant operating licences, public liability insurance, identity verification for principals. We handle most of the process — you provide access and document accuracy checks.",
  },
  {
    q: "What commission does Coastal Corridor take?",
    a: "Early-access cohort partners are locked at 8% for the first twelve months. Standard rate after that is 12%. Both rates are significantly below comparable platforms. We also do not charge listing fees, setup fees, or photography fees for early-access cohort members.",
  },
  {
    q: "Can I list if I'm based outside Nigeria?",
  ...
  {
    q: "What currencies can I receive payouts in?",
    a: "Naira to Nigerian accounts, USD to international accounts, or GBP to UK accounts — your choice, set per property or experience. Guests pay in their currency; we settle yours. Multi-currency payouts are available to all verified hosts and operators.",
  },
  {
    q: "How long does the application process take?",
    a: "We respond to every application within ten business days. If shortlisted, we schedule a 30-minute call within two to three weeks. Verification and listing creation typically takes four to six weeks. You will be live on the platform at launch in Q3 2026.",
  },
]
...
export default function ForOperatorsPage() {
  ...
  return (
    <div className="bg-[#faf8f3] text-[#0a0e12]">
      ...
      {/* ── HERO ── */}
      <section className="bg-[#0a0e12] text-[#faf8f3] px-6 md:px-12 pt-28 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-[1.4fr_1fr] gap-16 md:gap-20 items-end">
          <div>
            ...
            <p className="font-serif font-light text-xl text-[#faf8f3]/75 leading-relaxed max-w-[480px] mt-8">
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          {activePath && (
            <div className="mt-8 text-center">
              <button onClick={scrollToForm} className="bg-[#c96a3f] text-[#faf8f3] px-10 py-4 font-mono text-xs tracking-[0.2em] uppercase hover:bg-[#a85530] transition-colors">
      ...
      {/* ── DETAIL: HOSTS ── */}
      <section className="px-6 md:px-12 py-24 border-b border-[#d4d4d0]">
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-[1fr_1.6fr] gap-20 items-start">
          <div>
            ...
            <p className="font-serif italic text-lg text-[#6b7079] leading-relaxed">Five things current platforms cannot give you, that we will.</p>
          </div>
          <div className="flex flex-col gap-8">
            {[
              ...
              { num: '04', title: 'Listings that earn their place.', body: 'Verified listings only. Photographed to a consistent standard (we provide photography for early-access cohort properties). Written by people who understand both the property and the buyer. Your listing reads like Cereal Magazine, not a directory entry.' },
              { num: '05', title: 'Operational tools that respect your time.', body: 'Calendar synchronisation with your existing systems. Automated guest communication templates. Pricing tools tuned to corridor seasonality (Carnival Calabar, Christmas surge, dry-season peaks). Customer support handled by us, escalated to you only when needed.' },
            ].map(item => (
      ...
      <section className="bg-[#f5f1ea] px-6 md:px-12 py-24 border-b border-[#d4d4d0]">
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-[1fr_1.6fr] gap-20 items-start">
          <div>
            ...
            <p className="font-serif italic text-lg text-[#6b7079] leading-relaxed">Five things experience providers along the corridor have asked for.</p>
          </div>
          <div className="flex flex-col gap-8">
            {[
              ...
              { num: '02', title: 'Capacity management built for the corridor.', body: 'Multi-day itineraries, group bookings, weather contingency, equipment requirements, age restrictions. Tools designed for corridor experiences specifically — not generic GetYourGuide infrastructure ported to Nigeria.' },
              { num: '03', title: 'Event-anchored demand.', body: 'Carnival Calabar happens once a year. The Lagos season runs December through January. Eyo Festival, the Argungu Fishing Festival, weddings season — corridor demand is event-driven. We surface your inventory against the events that drive bookings, with promotion that competitors cannot match.' },
              { num: '04', title: 'Verified, insured, accountable.', body: "Operator verification (CAC registration, relevant licences, insurance) raises the bar for the whole category. Guests choose corridor operators because the alternative — an unverified WhatsApp contact — is the operational reality they're trying to avoid." },
              { num: '05', title: 'Economics that make sense.', body: 'Early-access commission rate: 8% for the first twelve months. Standard rate: 12%. No listing fees. No setup fees. No photography fees for early-access cohort members. You keep more of every booking than any comparable platform in this market.' },
            ].map(item => (
              <div key={item.num} className="grid grid-cols-[60px_1fr] gap-6 pb-8 border-b border-[#d4d4d0] last:border-0">
                <p className="font-mono text-[13px] tracking-[0.1em] text-[#c96a3f] pt-1">{item.num}</p>
                <div>
      ...
      {/* ── ECONOMICS ── */}
      <section className="bg-[#0a0e12] text-[#faf8f3] px-6 md:px-12 py-24 relative">
            ...
            {[
              {
                ...
                items: [
                  ...
                  { strong: 'Property inspection.', detail: 'Physical or video inspection of the property. We check condition, accuracy of listing description, and safety standards.' },
                  { strong: 'Photography.', detail: 'Professional photography to corridor standard. Provided free of charge for early-access cohort members.' },
                  { strong: 'Identity verification.', detail: "Government ID for the host principal. NIN, international passport, or driver's licence." },
                  { strong: 'Bank account verification.', detail: 'Verified Nigerian or international bank account for payout settlement.' },
                ],
              },
              {
                ...
                items: [
                  ...
                  { strong: 'Operator identity.', detail: 'Government ID for principals. Background checks for operators in higher-trust contexts (children\'s activities, residential transport, in-home services).' },
                ...
                <ul className="flex flex-col gap-5">
                  {col.items.map((item, i) => (
                    <li key={i} className="grid grid-cols-[28px_1fr] gap-4 text-[15px] leading-relaxed">
                      <span className="text-[#2d7d7d] font-serif text-lg font-medium">✓</span>
                      <span>
      ...
      {/* ── APPLICATION FORM ── */}
      <section ref={formRef} className="bg-[#0a0e12] text-[#faf8f3] px-6 md:px-12 py-24 relative" id="apply">
        <div className="absolute top-0 left-0 right-0 h-px"
          style={{ background: 'linear-gradient(90deg, #c96a3f 0%, #c96a3f 33%, #d4a24c 33%, #d4a24c 66%, #2d7d7d 66%, #2d7d7d 100%)' }} />
        <div className="max-w-[920px] mx-auto">
          ...
          {submitError && (
            <div className="bg-[#c96a3f]/20 border border-[#c96a3f] text-[#faf8f3] px-6 py-4 mb-8 text-sm">
              {submitError}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={submitting}
              className="bg-[#c96a3f] text-[#faf8f3] px-12 py-5 font-mono text-xs tracking-[0.2em] uppercase mt-6 hover:bg-[#a85530] transition-all hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0">
            ...
            {FAQS.map((faq, i) => (
              <div key={i} className="border-b border-[#d4d4d0]">
                <button
                  ...
                  className="w-full flex justify-between items-center py-7 text-left font-serif font-normal text-[22px] leading-snug hover:text-[#c96a3f] transition-colors">
                  {faq.q}
                  <span className={`font-mono text-[24px] text-[#c96a3f] font-light ml-8 flex-shrink-0 transition-transform duration-300 ${openFaq === i ? 'rotate-45' : ''}`}>+</span>
                </button>
