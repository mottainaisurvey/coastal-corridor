    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-12">
          <div className="flex items-center justify-between mb-auto">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="font-mono text-[9px] uppercase tracking-micro text-paper/50 mt-0.5">Developer Portal</div>
              </div>
            </Link>
          ...
          <div className="my-12">
            ...
            <h1 className="font-serif text-[40px] xl:text-[50px] font-light leading-[1.0] tracking-tightest mb-6">
              Welcome back to your developer portal.
            </h1>
            <p className="text-[15px] text-paper/60 leading-relaxed max-w-md">
              Manage your projects, track buyer inquiries, and monitor your listings across the Lagos–Calabar corridor.
            </p>
          </div>
          ...
          <div className="border-t border-paper/10 pt-6">
            <p className="text-[12px] text-paper/35">
              New developer?{' '}
              <Link href="/developer/sign-up" className="text-ocean-2 hover:text-ocean-3 transition-colors">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-paper px-6 py-12">
        <div className="lg:hidden mb-8 text-center">
          ...
          <div className="font-serif text-[20px] font-light">Developer Portal</div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <SignIn
            ...
            signUpUrl="/developer/sign-up"
            afterSignInUrl="/developer/dashboard"
            appearance={{
              elements: {
                rootBox: 'w-full',
