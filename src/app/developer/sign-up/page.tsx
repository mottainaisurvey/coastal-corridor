...
const DEVELOPER_PERKS = [
  'Showcase projects to 3,200+ verified diaspora buyers',
  'Verified listing tools with geo-tagging and title status',
  'Real-time project analytics and inquiry dashboard',
  'Direct access to KYC-verified high-net-worth buyers',
  'Fractional ownership and off-plan sales infrastructure',
  'Dedicated developer partnership and support team',
];
    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-12">
          <div className="flex items-center justify-between mb-auto">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="font-mono text-[9px] uppercase tracking-micro text-paper/50 mt-0.5">Developer Programme</div>
              </div>
            </Link>
            <Link href="/for-developers" className="flex items-center gap-1.5 text-paper/50 hover:text-paper/80 transition-colors text-[13px]">
          ...
          <div className="my-12">
            ...
            <h1 className="font-serif text-[40px] xl:text-[50px] font-light leading-[1.0] tracking-tightest mb-6">
              Put your inventory in front of the right buyers.
            </h1>
            <p className="text-[15px] text-paper/60 leading-relaxed max-w-md mb-8">
              Create your developer account. Our team will verify your CAC registration and project credentials within 48 hours and grant you full portal access.
            </p>
          ...
          <div className="border-t border-paper/10 pt-6">
            <p className="text-[12px] text-paper/35">
              Already an approved developer?{' '}
              <Link href="/developer/sign-in" className="text-ocean-2 hover:text-ocean-3 transition-colors">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-paper px-6 py-12">
        <div className="lg:hidden mb-8 text-center">
          <Link href="/for-developers" className="inline-flex items-center gap-2 text-ink/50 hover:text-ink text-[13px] mb-4 transition-colors">
            <ArrowLeft className="h-3.5 w-3.5" />
            Developer Programme
          </Link>
          <div className="font-serif text-[20px] font-light">Developer Application</div>
          <p className="text-[13px] text-ink/50 mt-2">Approved within 48 hours.</p>
        </div>
