...
const AGENT_PERKS = [
  'Access to 3,200+ verified diaspora buyers',
  'Verified listing tools with geo-tagging',
  'Real-time analytics dashboard',
  'Transparent commission tracking',
  'Developer partnership matching',
    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-12">
          <div className="flex items-center justify-between mb-auto">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="font-mono text-[9px] uppercase tracking-micro text-paper/50 mt-0.5">Agent Programme</div>
              </div>
            </Link>
          ...
          <div className="my-12">
            ...
            <h1 className="font-serif text-[40px] xl:text-[50px] font-light leading-[1.0] tracking-tightest mb-6">
              Start selling verified coastal real estate today.
            </h1>
            <p className="text-[15px] text-paper/60 leading-relaxed max-w-md mb-8">
              Create your agent account. Our team will review your credentials within 48 hours and grant you full dashboard access.
            </p>

            <div className="space-y-3">
              {AGENT_PERKS.map((perk) => (
          ...
          <div className="border-t border-paper/10 pt-6">
            <p className="text-[12px] text-paper/35">
              ...
              <Link href="/agent/sign-in" className="text-ocean-2 hover:text-ocean-3 transition-colors">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-paper px-6 py-12">
        <div className="lg:hidden mb-8 text-center">
          ...
          <div className="font-serif text-[20px] font-light">Agent Application</div>
